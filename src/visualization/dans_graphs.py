...
def adding_to_json_2():
    with open("src/visualization/world_paths_graph2.json", 'r') as file:
        formatted_results = json.load(file)
    ...
    for test in tqdm(tests_to_be_run):
        ...
        if int(test.get('percent_coverage')) == 0:
            ...
            with open("src/visualization/world_paths_graph2.json", 'w') as file:
                json.dump(formatted_results, file, indent=4)
...
def adding_to_json_1():
    with open("src/visualization/world_paths_graph1.json", 'r') as file:
        formatted_results = json.load(file)
    ...
    for test in tqdm(tests_to_be_run):
        ...
        if int(test.get('percent_coverage')) == 0:
            ...
            with open("src/visualization/world_paths_graph1.json", 'w') as file:
                json.dump(formatted_results, file, indent=4)
