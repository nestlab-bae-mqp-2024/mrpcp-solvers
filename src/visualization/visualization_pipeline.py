...
def run_visualization_pipeline(robot_node_path, robot_world_path, metadata):
    ...
    all_world_points = pseudo_simulate(robot_world_path, v=1., t=1800, dt=0.1)

    print(all_world_points)
    ...
    metadata = visualize_coverage_stepwise(5, discretized, metadata, t=1800, dt=0.1)
