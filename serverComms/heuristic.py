...
from serverComms.utils.tsp_solver import k_opt
from serverComms.utils.visualize import visualize_paths


def solve_mrpcp_heuristic(num_of_robots, interval, num_of_targets_per_side, redundancy_parameter, fuel_capacity_ratio, dist_per_side, job_id):
    ...
    visualize_paths(optimized_node_paths, nodes, node_indices, target_indices, depot_indices, cost, mode="faster", save_path=saveGraphPath(job_id, 'visualization.png'))
